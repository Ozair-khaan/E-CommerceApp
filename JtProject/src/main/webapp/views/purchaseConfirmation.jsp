        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                <ul class="navbar-nav align-items-center">
                    ...
                    <li class="nav-item"><a class="nav-link px-3" href="showCart"><i class="fas fa-shopping-cart"></i> Cart</a></li>
                    <li class="nav-item"><a class="nav-link px-3" href="profileDisplay">Profile</a></li>
